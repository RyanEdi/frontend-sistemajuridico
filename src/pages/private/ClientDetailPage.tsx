  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (pcd && documentoComprobatorioNome) {
        ...
        // Aqui os campos estão em inglês para coincidir com o "mapClientFields" do Backend
        ...
        // Enviando booleanos como string no FormData (o backend novo converte isso)
        ...
        // Buscar o arquivo do input file e enviar corretamente
        ...
        res = await fetch('https://www.direitoeprovento.com.br/api/clients', {
          ...
          body: formDataToSend, // O navegador ajusta automaticamente o Content-Type para multipart/form-data com boundary
        });
      } else {
