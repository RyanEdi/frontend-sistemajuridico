...
const PeticoesPage: React.FC = () => {
  ...
  useEffect(() => {
    document.title = 'Peti��es | Direito & Provento';
    ...
    // Verifica se o perfil est� incompleto (telefone ou OAB n�o preenchidos)
  ...
  return (
    <div className="ed-page">
      ...
      <AppTopbar
        searchPlaceholder="Pesquisar peti��es..."
        searchValue={search}
      ...
      <main className="ed-main">
        <div className="ed-main-inner">
          <div className="ed-heading-block">
            ...
            <h2>Peti��es</h2>
            <p>Crie e gerencie peti��es previdenci�rias dos seus clientes.</p>
          </div>
          ...
          {perfilIncompleto && !bannerDismissed && (
            <div className="pet-perfil-banner">
              ...
              <span>
                Seu perfil est� incompleto. Preencha seu <strong>telefone</strong> e dados da <strong>OAB</strong> para que as peti��es incluam seus dados de contato.
              </span>
            ...
            <div className="caso-table">
              ...
              {loading ? (
                ...
                <div style={{ padding: '3rem 0', textAlign: 'center' }}>
                  ...
                  <p className="db-empty">Nenhuma peti��o encontrada.</p>
                </div>
              ) : (
                filtradas.map(p => (
